...
var_dump($fetcher->findDirectories('/'));
var_dump($fetcher->findBy('/folder', function($filesystem) {
    return $filesystem instanceof Directory;
}));
var_dump($fetcher->findDirectoryByName('/folder'));
